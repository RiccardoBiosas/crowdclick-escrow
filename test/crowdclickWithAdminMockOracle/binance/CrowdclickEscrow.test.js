...
contract('CrowdclickEscrow contract with CrowdclickMockOracle as a data source for binance pricefeed', (accounts) => {
  ...
  before(async () => {
    currentUnderlying = await currencyApi.fetchBNBToUSD();
