...
contract('CrowdclickEscrow contract with CrowdclickOracle (with chainlink) as a data source', (accounts) => {
  ...
  /** contracts */
  let crowdclickEscrow; let crowdclickOracle; let
    crowdclickOracleAddress;
  /** balances */
  let publisherWalletBalance; let userWalletBalance; let feeCollectorWalletBalance; let publisherContractBalance; let
    userContractbalance;
  let collectedFee = 0;
